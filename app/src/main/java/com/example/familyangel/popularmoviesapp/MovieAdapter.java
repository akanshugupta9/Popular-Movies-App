...
public class MovieAdapter extends ArrayAdapter<Movie> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageView iconView = (ImageView) convertView.findViewById(R.id.gridImage);
        Picasso.with(getContext()).load("http://image.tmdb.org/t/p/w185/"+movie.posterLink).into(iconView);
        return convertView;
    }
}
